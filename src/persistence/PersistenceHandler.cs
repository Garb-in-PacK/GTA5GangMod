...
namespace GTA.GangAndTurfMod
{
    ...
    public static class PersistenceHandler
    {
        ...
        /// <summary>
        /// xmlReaderSettings used when loading files
        /// </summary>
        public static XmlReaderSettings ReaderSettings { get; private set; } = new XmlReaderSettings
        {
        ...
        public static void SaveToFile<T>(T dataToSave, string fileName, bool notifyMsg = true)
        {
            try
            {
                ...
                if (notifyMsg)
                {
                    UI.Screen.ShowSubtitle("saved at: " + filePath);
                }
